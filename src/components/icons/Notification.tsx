import { DocumentText1, NotificationBing, People } from "iconsax-react";
...
export default function Notification({ fill = "#6C7281", ...rest }) {
  return (
    // <DocumentText1 size="24" color={fill} />
    <NotificationBing size="24" color={fill} />
